        ...
        <div className="flex-1 relative h-full overflow-hidden flex flex-col">
            ...
            >
                ...
                <div className="bg-brand-blue px-6 pt-16 pb-12 relative z-[45] transition-colors duration-500 overflow-visible">
                    ...
                    <p className="text-[#A8B8CB] text-[22px] mb-1" style={{ fontFamily: "'Sansita', sans-serif", fontStyle: 'italic', fontWeight: 400 }}>{t('home.procrastinating')}</p>
                    {/* AI will call you - Sansita Bold Italic (主标题) */}
                    <h1 className="text-[48px] text-white mb-6" style={{ fontFamily: "'Sansita', sans-serif", fontStyle: 'italic', fontWeight: 700, lineHeight: 1.1 }}>{t('home.aiWillCallYou')}</h1>
