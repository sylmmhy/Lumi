                        ...
                        <div className="w-full lg:w-3/5 text-white mb-16 lg:mb-0">
                            ...
                            <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                                ...
                                <button
                                    ...
                                    className="px-8 py-5 bg-white text-[#2545BD] font-black text-lg rounded-full hover:bg-gray-50 transition-all shadow-xl hover:scale-105 active:scale-95 flex items-center gap-3"
                                >
                                    {/* Apple Logo */}
                                ...
                                <button
                                    ...
                                    className="px-8 py-5 bg-transparent text-white font-semibold text-lg rounded-full border-2 border-white/50 hover:bg-white/10 transition-all hover:scale-105 active:scale-95"
                                >
                                    Android Beta Access
                                </button>
                            </div>
