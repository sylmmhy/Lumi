...
COMMENT ON FUNCTION "public"."generate_daily_routine_instances"() IS '每日凌晨由 pg_cron 调用生成 routine_instance。2026-01-17 修复：添加 status=pending 过滤';
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."goal";
